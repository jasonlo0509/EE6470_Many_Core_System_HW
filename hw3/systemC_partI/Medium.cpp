...
Medium::Medium(sc_module_name n) : sc_module(n), t_skt("t_skt") {
...
void Medium::blocking_transport(tlm::tlm_generic_payload &payload, sc_core::sc_time &delay) {
  ...
  switch( payload.get_command() )
  {
    case tlm::TLM_READ_COMMAND:
      ...
      data_ptr[0] = buffer.pixel[0];
      data_ptr[1] = buffer.pixel[1];
      data_ptr[2] = buffer.pixel[2];
      data_ptr[3] = buffer.pixel[3];
      break;
