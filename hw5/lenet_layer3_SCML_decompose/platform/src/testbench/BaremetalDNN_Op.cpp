...
#include "runtime.h"
using namespace std;
extern "C" void fuse_conv2d_relu_1( void* args,  void* arg_type_ids, int num_args) {
  ...
  void* pad_temp = TVMBackendAllocWorkspace(13, dev_id, ((unsigned long)((((4 * 1) * 1) * 6) * 6)), 2, 32);
  if (pad_temp == NULL) {
    (void)assert(0);
  }
  for (int i2 = 0; i2 < 6; ++i2) {
    for (int i3 = 0; i3 < 6; ++i3) {
      (( float*)pad_temp)[((i2 * 6) + i3)] = input0[((i2 * 6) + i3)];
    }
  }
  void* compute = TVMBackendAllocWorkspace(13, dev_id, ((unsigned long)((((4 * 1) * 4) * 4) * 4)), 2, 32);
  if (compute == NULL) {
    (void)assert(0);
  }
  ...
  void* tensor = TVMBackendAllocWorkspace(13, dev_id, ((unsigned long)((((4 * 1) * 4) * 4) * 4)), 2, 32);
  if (tensor == NULL) {
    (void)assert(0);
  }
...
extern "C" void fuse_max_pool2d_1( void* args,  void* arg_type_ids, int num_args) {
